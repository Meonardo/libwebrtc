...
class BasicDesktopCapturer : public webrtc::VideoCaptureModule,
 ...
 public:
  ...
  virtual bool GetCurrentScreenList(libwebrtc::SourceList& sources) {
    return false;
  }
...
class BasicScreenCapturer : public BasicDesktopCapturer {
 public:
  ...
  virtual bool GetCurrentScreenList(libwebrtc::SourceList& sources) override;
...
class BasicWindowCapturer : public BasicDesktopCapturer {
 public:
  ...
  bool GetCurrentWindowList(libwebrtc::SourceList& sources) override;
