...
class RTCVideoCapturer : public RefCountInterface {
 public:
  ...
  virtual bool UpdateCaptureDevice(size_t width, size_t height,
                                   size_t target_fps,
                                   size_t capture_device_index) = 0;

  virtual void StartEncodeJpeg(const char* id, uint16_t delay_timeinterval,
...
class RTCVideoDevice : public RefCountInterface {
 public:
  ...
  virtual uint32_t GetCaptureDeviceCapabilityCount(const char* deviceUniqueIdUTF8) = 0;
